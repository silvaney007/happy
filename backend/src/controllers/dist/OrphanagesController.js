...
exports["default"] = {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        orphanages = _a.sent();
                        return [2 /*return*/, response.json(orphanages)];
                }
            });
        });
    },
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        orphanage = _a.sent();
                        return [2 /*return*/, response.json(orphanage)];
                }
            });
        });
    },
    create: function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, name, latitude, longitude, about, instructions, opening_hours, open_on_weekends, orphanagesRepository, requestImages, images, orphanage;
